...
namespace HR_Manager.App_code
{
    public class DatabaseHelper
    {
        ...
        /// </summary>
        /// <returns>Cadena de conexión para HRManagerDB.</returns>
...
/// <summary>
/// Este método ejecuta una consulta INSERT, UPDATE o DELETE en la base de datos, es decir, comandos que no devuelven resultados.<br />
/// Propósito: Ejecutar comandos SQL que modifican datos en la base de datos.<br />
/// Función: Acepta una consulta SQL y una lista de parámetros SQL (sqlParameters).<br />
/// ***Intenta abrir una conexión con la base de datos usando SqlConnection y SqlCommand para preparar la consulta.<br />
/// ***Si hay parámetros, los agrega al comando con cmd.Parameters.AddRange.<br />
/// ***Ejecuta el comando con cmd.ExecuteNonQuery(), que devuelve el núm
